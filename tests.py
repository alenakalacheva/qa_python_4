...
class TestBooksCollector:
    ...
    def test_delete_book_from_favorites_book_from_list(self,collector, add_book_with_genre):
        ...
        # получить жанр у книги без жанра
        # проверить что в списке нет левых жанров
        # получить пустой список книг по жанру
        # получить список жанров дебильное название метода, на самом деле это добавленный список книг
        # проверим что нет не подходящих книг для детей
        # добавим книгу в избранное
        # еще разок
        # и несуществующую книгу в избранное
        # удалим книгу из избранного
        # удалим несуществующую
        # получить список избранных - проверим что только избранные
